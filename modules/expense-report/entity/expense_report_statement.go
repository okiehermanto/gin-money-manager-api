...
type ExpenseReportStatement struct {
	...
	ExpenseReport   *ExpenseReport   `json:"expense_report,omitempty" gorm:"foreignKey:ExpenseReportID;references:ID"`
...
func (ExpenseReportStatement) EntityName() string {
	return "expense_report_statement"
}
